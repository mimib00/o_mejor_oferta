...
class ListingReport extends StatefulWidget {
  const ListingReport({super.key});

  @override
  State<ListingReport> createState() => _ListingReportState();
}

class _ListingReportState extends State<ListingReport> {
  String reson = "Select";
  ...
  Future<void> report() async {
    final data = {
      ...
      "listing": Get.parameters["id"],
    };
    try {
      Loader.instance.showCircularProgressIndicatorWithText();
      const url = "$baseUrl/listings/report/";
